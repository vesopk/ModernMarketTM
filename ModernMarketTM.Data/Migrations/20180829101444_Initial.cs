        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserInstances_CategoryInstances_CategoryInstanceId",
                        column: x => x.CategoryInstanceId,
                        principalTable: "CategoryInstances",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserInstances_Orders_OrderId1",
                        column: x => x.OrderId1,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserInstances_CategoryInstanceId",
                table: "UserInstances",
                column: "CategoryInstanceId");

            migrationBuilder.CreateIndex(
                name: "IX_UserInstances_OrderId1",
                table: "UserInstances",
                column: "OrderId1");
